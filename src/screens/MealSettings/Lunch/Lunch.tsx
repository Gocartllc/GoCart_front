// src/screens/LunchScreen/LunchScreen.tsx

import React, { useState } from 'react';
import { View, Text, TextInput, StyleSheet } from 'react-native';
import { styles } from './Lunch.styles';
import { LunchProps } from './Lunch.types';
...
const LunchScreen: React.FC<LunchProps> = ({ navigation, route }) => {
  ...
  const navigateToNextMeal = () => {
    // Update selectedMeals for Lunch
    let updatedSelectedMeals = { ...selectedMeals, Lunch: false };
    ...
    if (updatedSelectedMeals.Dinner) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Lunch Plan</Text>
 ...
 <View style={dropstyle.container}>
      ...
      <Text style={styles.question}>What is the max calorie count for a Lunch dish?</Text>
      <PremiumTextField
        placeholder="Max"
        iconName="calculator"
      ...
      <Text style={styles.question}>What is the minimum calorie you're willing to take for a Lunch dish?</Text>
      <PremiumTextField
        placeholder="Min"
        iconName="numeric"
        secureTextEntry={false}
