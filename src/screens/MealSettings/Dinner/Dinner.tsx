// src/screens/DinnerScreen/DinnerScreen.tsx

import React, { useState } from 'react';
import { View, Text, TextInput, StyleSheet } from 'react-native';
import { styles } from './Dinner.styles';
...
const DinnerScreen: React.FC<DinnerProps> = ({ navigation, route }) => {
  ...
  const navigateToNextMeal = () => {
    ...
    let updatedSelectedMeals = { ...selectedMeals, Dinner: false };
    ...
    if (updatedSelectedMeals.Dinner == false) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Dinner Plan</Text>
 ...
 <View style={dropstyle.container}>
      ...
      <Text style={styles.question}>What is the max calorie count for a Dinner dish?</Text>
      <PremiumTextField
        placeholder="Max"
        iconName="calculator"
      ...
      <Text style={styles.question}>What is the minimum calorie you're willing to take for a Dinner dish?</Text>
      <PremiumTextField
        placeholder="Min"
        iconName="numeric"
        secureTextEntry={false}
